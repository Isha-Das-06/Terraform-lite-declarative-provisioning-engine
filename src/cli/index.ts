...
async function handleApply(args: string[]): Promise<void> {
  ...
  const providers = new Map<string, any>([
    ["file", new FilesystemProvider()],
    ["directory", new FilesystemProvider()],
    ["template", new FilesystemProvider()],
    ["docker_image", new DockerProvider()],
    ["docker_container", new DockerProvider()],
    ["docker_network", new DockerProvider()],
    ["sqlite_database", new LocalDBProvider()],
    ["sqlite_table", new LocalDBProvider()],
  ]);
